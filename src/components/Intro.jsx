            ...
            <div className="intro" >
                <div>
                    ...
                    transition={{type:'spring',duration:0.5,stiffness:160}}
                     >
                        Handle your <span className="accent">finances<TbMoneybag/></span>  with ease.
                    </motion.h1>
                    <motion.p
                    initial={{x:-1000}}
                    animate={{x:0}}
                    transition={{type:'spring',duration:1,}}
                    >Unlock financial freedom through personal budgeting. Centralize your finances in one place and get started today.<aside style={{display:"inline-flex",alignItems:"center"}}>Get Started<AiOutlineArrowDown/></aside></motion.p>
